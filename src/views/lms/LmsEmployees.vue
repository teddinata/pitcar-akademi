<template>
  <div class="min-h-screen bg-gray-50 p-4 md:p-6">
    ...
    <!-- ── SEARCH TAB FILTERS ── -->
    <div v-if="activeTab === 'search'" class="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-5 flex flex-wrap gap-3">
      <input
        v-model="searchQuery"
        @input="debouncedLoad"
    ...
    <!-- ── PROFILE TAB FILTERS ── -->
    <div v-else-if="activeTab === 'profile'" class="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-5 flex flex-wrap gap-3 items-start">
      <EmployeePicker
    ...
    <div v-else-if="activeTab === 'compliance'" class="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-5 flex flex-wrap gap-3 items-center">
      <select
        v-model="filterDeptId"
    ...
    <div v-else-if="activeTab === 'auto_enroll'" class="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-5 flex flex-wrap gap-3 items-start">
      <EmployeePicker
    ...
    <div v-else-if="activeTab === 'performance'" class="bg-white rounded-xl border border-gray-100 shadow-sm p-4 mb-5 flex flex-wrap gap-3 items-start">
      <EmployeePicker
    ...
    <template v-else-if="activeTab === 'profile'">
      ...
      <div v-else class="space-y-4">
        ...
        <!-- Kursus Selesai -->
        <div v-if="data.completed_enrollments?.length" class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
          <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <div v-if="!data.current_enrollments?.length && !data.completed_enrollments?.length" class="bg-white rounded-xl border border-gray-100 shadow-sm p-5 text-center text-gray-400 text-sm">
    ...
    <template v-else-if="activeTab === 'compliance'">
      ...
      <div v-else>
        ...
        <div v-if="data.non_compliant_list?.length" class="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
          <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <div v-else class="bg-white rounded-xl border border-gray-100 shadow-sm p-10 text-center text-green-600 font-medium">
    ...
    <template v-else-if="activeTab === 'performance'">
      ...
      <div v-else class="space-y-4">
        ...
        <div v-if="data.insights?.length" class="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
